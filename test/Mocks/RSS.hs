...
feeds =
  [ (nullFeed empty)
    { feedAuthor = Just "editor@example.com"
  ...
  , (nullFeed empty)
    ...
    , feedDescription =
      Just
        "Productivity hacks weekly in bite-size chunks. Just up your alley if you&#39;re <br/>at least slightly geeky or a tad bit obsessed with Evernote or WorkFlowy!"
    , feedFormat = Just RSS2
    , feedGenerator =
...
posts =
  [ [ nullPost
      { postAuthor = Nothing
      , postDate = Just "Tue, 03 Jun 2003 09:39:21 GMT"
      , postDescription =
        Just
    ...
    , nullPost
      { postAuthor = Nothing
      , postDate = Just "Fri, 30 May 2003 11:06:42 GMT"
      , postDescription =
        Just
    ...
    , nullPost
      { postAuthor = Nothing
      , postDate = Just "Tue, 27 May 2003 08:37:32 GMT"
      , postDescription =
        Just
    ...
    , nullPost
      { postAuthor = Nothing
      , postDate = Just "Tue, 20 May 2003 08:56:02 GMT"
      , postDescription =
        Just
  ...
  , [ nullPost
      { postAuthor = Just "Lea Verou"
      , postDate = Just "Fri, 26 Aug 2016 20:07:58 +0000"
      , postDescription =
        Just
    ...
    , nullPost
      { postAuthor = Just "Lea Verou"
      , postDate = Just "Tue, 31 May 2016 22:13:00 +0000"
      , postDescription =
        Just
    ...
    , nullPost
      ...
      , postSummary =
        Just
          "Women speaking up about the sexism they have experienced in tech is great\160for raising awareness about the issues. However, when no positive stories get out, the overall picture painted is bleak, which could scare even more women away. Lucky for me, I fell in love with programming a decade\160before I even heard there is a [&#8230;]"
