...
<html lang=en itemscope itemtype="http://schema.org/Blog">
  ...
  <main>
    <article itemscope itemtype="http://schema.org/BlogPosting">
      <header >
        <img src=/assets/images/example.jpg alt="A sample photo" srcset="/assets/images/example.jpg 750w, /assets/images/example.jpg 1500w">
        <div class="flex contacts end"></div>
...
malformedHtmlExpected :: String
malformedHtmlExpected  = [r|<div itemprop="articleBody" class="entry-content"><p>first paragraph</p><p>second paragraph</p><div>more stuff</div></div>|]

malformedHtmlInput :: String
malformedHtmlInput = [r|
<!DOCTYPE html>
<html lang=en itemscope itemtype="http://schema.org/Blog">
  <head>
    <link rel=home title=Home href=/index.php>
  ...
  <script>
  /* http://prismjs.com/download.html?themes=prism-coy&languages=markup+css+css-extras+clike+javascript+php+scss */
  ...
  (function(){
  if (document.querySelectorAll(".codetable").length > 0) {
        var headertext = [],
        headers = document.querySelectorAll(".codetable th"),
        tablerows = document.querySelectorAll(".codetable th"),
        tablebody = document.querySelector(".codetable tbody");
